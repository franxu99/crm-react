  ...
  return (
    <div className='md:flex md:min-h-screen'>
      <aside className='md:w-1/4 bg-blue-800 px-5 py-10'>
        ...
        <nav className='mt-10'>
          <Link //Link es ideal para crear una barra de navegacion y redireccionar al usuario, es mejor en cuanto a rendimiento que NavLink
        ...
        {/* NavLink es una opcion para los nav, y tiene la caracteristica de los enlaces activos para dar estilos */}
